...
describe("PreferencesDialog", () => {
  ...
  describe("Dialog rendering", () => {
    ...
    it("displays all preference sections", () => {
      ...
      const sampleMgmt = screen.getAllByRole("button", { name: "Sample Management" });
  ...
  describe("Theme preferences", () => {
    it("displays current theme mode", () => {
      ...
      const appearanceTab = screen.getAllByRole("button", { name: "Appearance" })[0];
    ...
    it("updates theme mode to light", async () => {
      ...
      const lightSpan = screen.getAllByText("Light").find(el => el.tagName === 'SPAN');
    ...
    it("updates theme mode to dark", async () => {
      ...
      // The theme buttons are the ones with the theme names as siblings
      const darkSpan = screen.getAllByText("Dark").find(el => el.tagName === 'SPAN');
    ...
    it("updates theme mode to system", async () => {
      ...
      // The theme buttons are the ones with the theme names as siblings
      const systemSpan = screen.getAllByText("System").find(el => el.tagName === 'SPAN');
  ...
  describe("Dialog interactions", () => {
    ...
    it("does not close when clicking dialog content", () => {
      ...
      const dialogContent = document.querySelector('.bg-white.dark\\:bg-slate-800') as HTMLElement;

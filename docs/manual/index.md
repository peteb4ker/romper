...
- [Kit Editor](kit-editor) -- Editing voices, assigning samples, and previewing sounds
  - [Step Sequencer](step-sequencer) -- Programming patterns, trigger conditions, and sample modes

...
import { FiArrowLeft, FiChevronLeft, FiChevronRight,FiFolder } from 'react-icons/fi';
...
const KitHeader: React.FC<KitHeaderProps> = ({
    ...
    <div className="flex items-center mb-2 gap-2">
        ...
        {onBack && (
            <button className="px-2 py-1 text-xs bg-gray-300 dark:bg-slate-700 text-gray-800 dark:text-gray-100 rounded hover:bg-gray-400 dark:hover:bg-slate-600" onClick={() => onBack()} title="Back">
        ...
        {onNextKit && kits && kitIndex !== undefined && (
            <button
                ...
                style={kitIndex === kits.length - 1 ? { opacity: 0.5, cursor: 'not-allowed' } : {}}
            >

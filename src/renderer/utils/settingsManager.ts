export const getSetting = async (key: 'sdCardPath' | 'darkMode'): Promise<any> => {
    return window.electronAPI.getSetting(key);
};

export const setSetting = async (key: 'sdCardPath' | 'darkMode', value: any): Promise<void> => {
...
export const applyTheme = async (): Promise<void> => {
    try {
        ...
        if (typeof darkMode === 'boolean') {
            ...
            console.log('applyTheme: No darkMode found in settings, defaulting to light mode');
        }

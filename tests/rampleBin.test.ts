...
import { readRampleBin, writeRampleBin } from '../src/main/rampleBin';

describe('rampleBin', () => {
    const testFile = path.join(__dirname, 'fixtures', 'rample.bin');
    const tempFile = path.join(__dirname, 'fixtures', 'rample.bin.tmp');
